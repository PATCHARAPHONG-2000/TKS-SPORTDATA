...
<body class="hold-transition sidebar-mini">
    ...
    <!-- <script scr="../../assets/js/superadmin-ad/setting/image-event.js"></script> -->
                ...
                data.response.forEach(function(item, index) {
                    if (item.name !== null) {
                        tableData.push([
                            ++index,
                            item.name,
                            `<img src="../../service/superadmin_ad/setting/uploads${item.image}" alt="Image" style="max-width: 150px;">`,
