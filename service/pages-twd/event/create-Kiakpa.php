...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $age_group = $_POST['Kiakpa_age'];
    $kiakpa = $_POST['Kiakpa_types'];
        ...
        if (!empty($ids)) {
            ...
            if ($rows) {
                foreach ($rows as $row) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO event ( ID_Number, firstname, lastname, gender, team, age, license, image, name_match, type_Name, age_group, kiakpa ) 
                        VALUES (:ID_Number, :firstname, :lastname, :gender, :team, :age, :license, :image, :name_match, :type_Name, :age_group, :kiakpa )");
                    ...
                    $stmt->bindParam(':kiakpa', $kiakpa, PDO::PARAM_STR);
