        ...
        if (!empty($ids)) {
            ...
            if ($rows) {
                foreach ($rows as $row) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO event ( ID_Number, firstname, lastname, gender, team, age, license, image, name_match, type_Name ) 
                                            VALUES (:ID_Number, :firstname, :lastname, :gender, :team, :age, :license, :image, :name_match, :type_Name )");
