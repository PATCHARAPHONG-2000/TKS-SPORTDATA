    ...
    <script>
        $(function () {
            $.ajax({
                ...
                let tableData = []
                let allowEdit = <?php echo (isset($set['name']) && $set['name'] == 'btn-add_data' && isset($set['IsActive']) && $set['IsActive'] == 1) ? 'true' : 'false'; ?>;
