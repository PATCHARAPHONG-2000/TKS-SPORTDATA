...
$(function () {
  $.ajax({
    type: "GET",
    url: "../../service/superadmin_ad/setting/image/index.php",
  })
    .done(function (data) {
      let tableData = [];
      data.response.forEach(function (item, index) {
        if (item.name !== null) {
          tableData.push([
            ++index,
            item.name,
            `<img src="../../service/superadmin_ad/uploads/${item.image}" alt="Image" style="max-width: 150px;">`,
    ...
    var table = $("#logs").DataTable({
      ...
      fnDrawCallback: function () {
        ...
        $(".toggle-image").change(function () {
          ...
          $.ajax({
            type: "POST",
            url: "../../service/superadmin_ad/setting/image_create.php",
            data: {
              imageon: imageon,
              isActive: isActive,
            },
    ...
    $(document).on("click", "#delete", function () {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          $.ajax({
            type: "POST",
            url: "../../service/superadmin_ad/setting/image_delete.php",
            data: {
              id: id,
            },
          }).done(function () {
