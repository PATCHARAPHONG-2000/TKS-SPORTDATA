    ...
    <script>
        ...
        $(function () {
            $('#formdata').on('submit', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../../service/superadmin/setting/image/image.php',
                ...
                var table = $('#logs').DataTable({
                    ...
                    fnDrawCallback: function () {
                        ...
                        $('.toggle-image').change(function () {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../service/superadmin/setting/image/image_create.php',
                ...
                $(document).on('click', '#delete', function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "../../service/superadmin/setting/image/image_delete.php",
                                data: { id: id },
                            }).done(function () {
                                Swal.fire({
